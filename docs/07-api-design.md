...
# 6.7 Recommendations API

### Purpose

The Recommendations API manages maintenance recommendations generated by the AIMD decision engine.

| Method | Endpoint | Description |
|---------|----------|-------------|
| GET | `/recommendations` | Retrieve recommendations |
| POST | `/recommendations` | Generate a recommendation |
